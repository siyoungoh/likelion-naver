...
# API 인증 정보
voice_storage_info = {'client_id': "내 client_id",
...
# object storage 용 정보
# 계정 API 인증 정보 - https://www.ncloud.com/mypage/manage/authkey
storage_info = {'access_key': '내 Access Key ID',
                'secret_key': '내 Secret Key'}
local_info = {'local_folder': 'mp3_folder', 'local_file': 'default.mp3'}
bucket_info = {'bucket_name': '내버킷이름',
